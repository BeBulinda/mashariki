...
$view_demo = __( 'View Demo', 'stronghold');
$upgrade_to_pro = __( 'Upgrade To Pro', 'stronghold' );
...
function wbls_theme_page() {
	add_theme_page( 
		__( 'Upgrade To StrongHold Pro','stronghold'),
		__( 'Theme Upgrade','stronghold'),
		'edit_theme_options',
		'wbls_upgrade',
					...
					'general' => array(
						...
						'fields' => array(
							...
							'breadcrumb_char' => array(
								...
								'sanitize_callback' => 'breadcrumb_char_choices',
								'default' => '1',
							),
						),
					),
