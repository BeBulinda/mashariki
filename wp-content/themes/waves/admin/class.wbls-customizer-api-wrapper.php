<?php
	...
	class Wbls_Customizer_API_Wrapper {
		...
		public function enqueue_scripts() {
			...
			wp_localize_script( 'customizer-js', 'waves_upgrade', array( 'message' => __( 'Get Pro for just $39', 'waves' ), 'docs' => __( 'Documentation', 'waves' ), 'demo' => __( 'Demo', 'waves' ), 'support' => __( 'Ask a Question', 'waves' ) ) );
		}
